const id = "utopia-fluid-typescales.md";
						const collection = "blog";
						const slug = "utopia-fluid-typescales";
						...
						const data = {title:"Utopia Fluid Typing",description:"Bring bring dynamic type scaling to your websites",pubDate:new Date(1694156400000),cover:{image:
						new Proxy({"src":"/_astro/typescale.37cc8142.webp","width":700,"height":700,"format":"webp"}, {
					...
					,alt:"Artful depiction of various characters in different font styles"},tags:[]};
						const _internal = {
							type: 'content',
							filePath: "/home/chris/Documents/projects/personal-website/src/content/blog/utopia-fluid-typescales.md",
