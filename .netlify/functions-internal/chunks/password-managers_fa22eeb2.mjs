const id = "password-managers.md";
						const collection = "blog";
						const slug = "password-managers";
						...
						const data = {title:"Password Managers are Great!",description:"Improve your online security, at your convenience",pubDate:new Date(1694761200000),cover:{image:
						new Proxy({"src":"/_astro/password_manager.e81bc570.webp","width":700,"height":700,"format":"webp"}, {
					...
					,alt:"Cartoon of happy old man on beach enjoying convenient cyber security"},tags:[]};
						const _internal = {
							type: 'content',
							filePath: "/home/chris/Documents/projects/personal-website/src/content/blog/password-managers.md",
