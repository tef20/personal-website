const id = "utopia-fluid-typescales.md";
						...
						const data = {title:"Utopia Fluid Typing",description:"Bring bring dynamic type scaling to your websites",pubDate:new Date(1694156400000),heroImage:"/blog-placeholder-3.jpg"};
						const _internal = {
							type: 'content',
