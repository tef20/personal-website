const id = "password-managers.md";
						...
						const data = {title:"Password Managers are Great!",description:"Improve your online security, at your convenience",pubDate:new Date(1694761200000),heroImage:"/blog-placeholder-3.jpg"};
						const _internal = {
							type: 'content',
